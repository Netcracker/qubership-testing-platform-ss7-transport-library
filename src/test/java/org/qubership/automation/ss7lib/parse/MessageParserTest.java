...
public class MessageParserTest {
    ...
    public void prepareMessage1() throws Exception {
        message1 = DumpReader.getMessage("/test_data/FullMessage1.stringdump");
    }
...
//    @Test/*TODO Actualise the test*/
    ...
    public void parseTest2() {
        ...
        byte[] correctMessage = new byte[]{0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, (byte) 0xec,
                ...
                (byte) 0x81, 0x01, 0x00, (byte) 0xa2, 0x03, (byte) 0x80, 0x01, 0x01,
                0x30, 0x0b, (byte) 0x80, 0x01, 0x09, (byte) 0x81, 0x01, 0x00,
                (byte) 0xa2, 0x03, (byte) 0x80, 0x01, 0x02, 0x30, 0x06, (byte) 0x80,
...
//    @Test/*TODO Actualise the test*/
    ...
    public void parseTest3() {
        ...
        ByteBuffer buffer = FullMessageEncoder.encode(pojoList);
        byte[] correctMessage = new byte[]{0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, (byte) 0xd7, 0x02, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00,
                0x02, 0x10, 0x00, (byte) 0xc9, 0x00, 0x00, 0x03, 0x20, 0x00, 0x00, 0x01, 0x7f, 0x03, 0x02, 0x00, 0x15,
                0x09, (byte) 0x81, 0x03, 0x0c, 0x15, 0x09, (byte) 0x8a, (byte) 0x92, 0x0a, 0x51, 0x41, 0x24, 0x04, 0x35, 0x04, 0x09,
                (byte) 0x8a, (byte) 0x92, 0x0a, 0x51, 0x41, 0x24, 0x04, 0x15, 0x04, (byte) 0x9d, 0x62, (byte) 0x81, (byte) 0x9a, 0x48, 0x04, 0x00,
                0x00, 0x00, 0x07, 0x6b, 0x1e, 0x28, 0x1c, 0x06, 0x07, 0x00, 0x11, (byte) 0x86, 0x05, 0x01, 0x01, 0x01,
                (byte) 0xa0, 0x11, 0x60, 0x0f, (byte) 0x80, 0x02, 0x07, (byte) 0x80, (byte) 0xa1, 0x09, 0x06, 0x07, 0x04, 0x00, 0x00, 0x01,
                0x00, 0x32, 0x01, 0x6c, 0x72, (byte) 0xa1, 0x70, 0x02, 0x01, 0x00, 0x02, 0x01, 0x00, 0x30, 0x68, (byte) 0x80,
                0x01, 0x03, (byte) 0x83, 0x07, 0x04, 0x15, 0x61, 0x10, 0x51, 0x28, (byte) 0x91, (byte) 0x97, 0x02, (byte) 0x91, (byte) 0x81, (byte) 0xbb,
                0x05, (byte) 0x80, 0x03, (byte) 0x80, (byte) 0x90, (byte) 0xa3, (byte) 0x9c, 0x01, 0x02, (byte) 0x9f, 0x32, 0x08, 0x03, 0x52, 0x01, 0x02,
                0x20, 0x04, 0x50, (byte) 0xf3, (byte) 0xbf, 0x34, 0x17, 0x02, 0x01, 0x00, (byte) 0x81, 0x07, (byte) 0x91, 0x51, 0x41, 0x24,
                0x04, 0x15, (byte) 0xf4, (byte) 0xa3, 0x09, (byte) 0x80, 0x07, 0x03, 0x02, 0x15, 0x1b, 0x58, 0x36, (byte) 0x9c, (byte) 0x9f, 0x36,
                0x07, 0x04, 0x40, 0x14, 0x23, (byte) 0xb0, (byte) 0xd7, 0x00, (byte) 0x9f, 0x37, 0x07, (byte) 0x91, 0x51, 0x41, 0x24, 0x04,
                0x15, (byte) 0xf4, (byte) 0x9f, 0x38, 0x07, (byte) 0x91, 0x31, (byte) 0x90, 0x29, (byte) 0x97, (byte) 0x84, 0x65, (byte) 0x9f, 0x39, 0x08, 0x02,
    ...
    @Test
    public void givenEventReportBCSM_with7digitDestinationId_whenWeSendIt_thenss7AddsAditonalk0beforeDestinationId() throws IOException, URISyntaxException {
    ...
    @Test
    public void testParseDiconnect() throws IOException, URISyntaxException {
