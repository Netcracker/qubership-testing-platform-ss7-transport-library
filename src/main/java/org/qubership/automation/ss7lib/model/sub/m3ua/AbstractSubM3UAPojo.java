...
public abstract class AbstractSubM3UAPojo {
    ...
    public void setParameterTag(ParameterTag parameterTag) {
    ...
    public String toString() {
        return ", parameterTag=" + getParameterTag() + ", parameterLength=" + getParameterLength();
    }
}
